...
func main() {
	structSample()
	levante := vehicle{"Maserati", "Levante", "2016 3.0T S"}
	fmt.Println("struct before modife:", levante)
	modifyStruct(&levante)
	fmt.Println("struct after modife:", levante)
}
